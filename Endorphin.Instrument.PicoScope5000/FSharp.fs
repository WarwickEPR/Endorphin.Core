...
module PicoScope5000FSharp =
    ...
    let setChannelSettings channel channelSettings (picoScopeAgent : PicoScope5000Agent) =
    ...
    let observeSamples (obs : IObservable<ChannelData>) =
        obs.ObserveSamples()