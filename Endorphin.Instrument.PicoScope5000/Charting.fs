...
module ChartingExtensions =
    ...
    // Provides charting extension member methods for PicoScope 5000 series StreamWorker.
    type StreamWorker with
        ...
        member streamWorker.LiveChartXY
        ...
        /// in a user interface. 
        member streamWorker.LiveChartAll
           (refreshInterval : TimeSpan,
