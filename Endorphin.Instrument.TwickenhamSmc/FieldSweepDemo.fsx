...
async {
    ...
    try
        let sweepParameters = 
            ...
            <| MagnetController.Output.Current.toStepIndex magnetController 0.5<A>
            <| MagnetController.Output.Current.toStepIndex magnetController 0.9<A>
            <| MagnetController.Ramp.Rate.nearestIndex magnetController 0.05<A/s>
