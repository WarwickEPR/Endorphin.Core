...
let info =
  [ "project-name", "Endorphin.Core"
    "project-author", "University of Warwick EPR and Diamond group"
    "project-summary", "Core infrastructure for scientific instrument control software development in F#."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Endorphin.Core" ]
