...
module CommandRequestAgent =
    ...
    module Model =
        ...
        type CommandRequestAgent<'State> = internal CommandRequestAgent of MailboxProcessor<CommandRequestMessage<'State>>
    ...
    module CommandRequestAgent =
        ...
        let create<'State> (nameFunc : 'State -> string) (init : unit -> Async<Choice<'State, exn>>) = async {
            ...
            <| MailboxProcessor.Start(fun (mailbox : MailboxProcessor<CommandRequestMessage<'State>>) ->
